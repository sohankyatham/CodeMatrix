...
def SaveFile(*args):
    ...
    if OpenFileStatusName:
        ...
        FilePath.close()                      
        # Add a asterisk (*) when file isnt saved - and when file is saved then remove asterisk
...
SettingsMenu.config(bg="White", fg="Black", activebackground="Whitesmoke", activeforeground="Black", activeborderwidth=1, font=('Monaco', 11))
...
SettingsMenu.add_command(label="Keyboard Shortcuts", command=None)
